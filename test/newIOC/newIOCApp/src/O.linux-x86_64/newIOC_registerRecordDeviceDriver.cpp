...
/* Generated from ../O.Common/newIOC.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devnewIOCVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLsiEnviron", "devlsiStream", "devnewIOCVersion", "devLsoSoft",
    ...
    "asynInt64TimeSeries", "devWfPDBDemo", "devXxxSoft"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devlsiStream, pvar_dset_devnewIOCVersion,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_drvModbusAsynRegister, pvar_func_helloRegister,
    pvar_func_initTraceRegister, pvar_func_installPVAAddLinkHook,
    pvar_func_modbusInterposeRegister, pvar_func_refTrackRegistrar,
...
int newIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/test/newIOC";
...
/* newIOC_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"newIOC_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(newIOC_registerRecordDeviceDriver(*iocshPpdbbase));
}
