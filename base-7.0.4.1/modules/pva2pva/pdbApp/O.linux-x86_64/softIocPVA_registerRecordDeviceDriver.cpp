...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_decInitialize, pvar_func_dlloadRegistar,
    pvar_func_installPVAAddLinkHook, pvar_func_iocshSystemCommand,
...
int softIocPVA_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/base-7.0.4.1";
...
{
    iocshSetError(softIocPVA_registerRecordDeviceDriver(*iocshPpdbbase));
}
