...
/* Generated from ../O.Common/reasonTest.dbd */
...
epicsShareExtern reg_func pvar_func_ADSConfigureRegister,
...
int reasonTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/modules/dynamicAsyn-1.1.0";
    ...
    pvar_func_ADSConfigureRegister();
...
/* reasonTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"reasonTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(reasonTest_registerRecordDeviceDriver(*iocshPpdbbase));
}
