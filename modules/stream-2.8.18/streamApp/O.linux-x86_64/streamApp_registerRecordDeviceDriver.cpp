...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devI64inSoftCallback, *pvar_dset_devint64inStream,
...
static const char * const deviceSupportNames[] = {
    ...
    "devSiGeneralTime", "devSiEnviron", "devstringinStream", "devSoSoft",
...
int streamApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/modules/stream-2.8.18";
...
{
    iocshSetError(streamApp_registerRecordDeviceDriver(*iocshPpdbbase));
}
