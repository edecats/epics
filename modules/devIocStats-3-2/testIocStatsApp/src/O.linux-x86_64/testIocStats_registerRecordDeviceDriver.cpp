...
/* Generated from ../O.Common/testIocStats.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_testCpuUseRegistrar, pvar_func_testSuspensionRegistrar,
...
int testIocStats_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/opt/epics/modules/devIocStats-3-2";
    ...
    pvar_func_testCpuUseRegistrar();
    pvar_func_testSuspensionRegistrar();
...
/* testIocStats_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testIocStats_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(testIocStats_registerRecordDeviceDriver(*iocshPpdbbase));
}
