...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_asynAoInt64, *pvar_dset_devAoTestGpib,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "asynAiInt64", "devAiTestGpib", "devGpib",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32",
    "asynAoFloat64", "asynAoInt64", "devAoTestGpib", "asynRecordDevice",
    "devBiSoft", "devBiSoftRaw", "devBiSoftCallback", "devBiDbState",
    "asynBiInt32", "asynBiUInt32Digital", "devBiTestGpib", "devBoSoft",
    ...
    "asynLiInt32", "asynLiUInt32Digital", "asynLiInt64", "devLiTestGpib",
    "devLoSoft", "devLoSoftCallback", "asynLoInt32",
    "asynLoUInt32Digital", "asynLoInt64", "devLoTestGpib", "devLsiSoft",
    "devLsiEnviron", "devLsoSoft", "devLsoSoftCallback", "devLsoStdio",
    "devMbbiSoft", "devMbbiSoftRaw", "devMbbiSoftCallback",
    "asynMbbiInt32", "asynMbbiUInt32Digital", "devMbbiTestGpib",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynAiInt64, pvar_dset_devAiTestGpib, pvar_dset_devGpib,
...
int testGpib_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/modules/asyn-4-38";
...
{
    iocshSetError(testGpib_registerRecordDeviceDriver(*iocshPpdbbase));
}
