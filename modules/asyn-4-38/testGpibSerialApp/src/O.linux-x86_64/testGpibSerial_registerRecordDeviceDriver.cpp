...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiTestGpib, *pvar_dset_devAoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "asynAiInt64", "devAiTestGpib", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32", "asynAoFloat64",
    "asynAoInt64", "devAoTestGpib", "asynRecordDevice", "devBiSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynAiInt64, pvar_dset_devAiTestGpib, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
...
{
    iocshSetError(testGpibSerial_registerRecordDeviceDriver(*iocshPpdbbase));
}
