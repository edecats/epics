...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_testModbusSyncIORegister, pvar_func_tsInitialize;
...
int modbus_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/opt/epics/modules/modbus-3-2";
...
{
    iocshSetError(modbus_registerRecordDeviceDriver(*iocshPpdbbase));
}
